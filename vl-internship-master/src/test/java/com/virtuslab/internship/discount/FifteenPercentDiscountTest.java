...
public class FifteenPercentDiscountTest {
    ...
    void shouldApplyDiscount() throws Exception {
        ...
        expectedTotalPrice = expectedTotalPrice.add(cereals.price());
        expectedTotalPrice = expectedTotalPrice.add(steak.price());
        expectedTotalPrice = expectedTotalPrice.multiply(BigDecimal.valueOf(0.85));
    ...
    void shouldNotApplyDiscount() throws Exception {
        ...
        var discount = new FifteenPercentDiscount();
        var receiptAfterDiscount = discount.apply(receipt);
        var expectedTotalPrice = cheese.price().multiply(BigDecimal.valueOf(4));
